import { accountColumns } from '@/components/userBaseComponent/super-admin/table/account/AccountTableConfig';
import { AccountTableToolbar } from '@/components/userBaseComponent/super-admin/table/account/AccountTableToolbar';
