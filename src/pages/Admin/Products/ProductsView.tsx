import { productListColumns } from '@/components/admin/table/productList/ProductTableConfig';
import { ProductTableToolbar } from '@/components/admin/table/productList/ProductTableToolbar';
import { DataTable } from '@/components/defaults/table/DataTable';
import Typography from '@/components/defaults/Typography';
import { useGetProductsQuery } from '@/pages/api/productApiSlice copy';
import {
  getFilters,
  getPagination,
  getRefetchStatus,
