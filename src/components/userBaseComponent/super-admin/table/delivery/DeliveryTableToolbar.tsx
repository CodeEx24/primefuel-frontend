...
import { accountFilterConfig } from './DeliveryTableConfig';
import { AddEntityButton } from '../../../../defaults/button/AddEntityButton';
import DeliveryForm from '../../forms/DeliveryForm';

interface DeliveryTableToolbarProps<TData> {
  table: Table<TData>;
}

export function DeliveryTableToolbar<TData>({
  table,
}: DeliveryTableToolbarProps<TData>) {
