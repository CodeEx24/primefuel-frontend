...
import { productTypesFilterConfig } from './ProductTypesTableConfig';
import { AddEntityButton } from '../../../../defaults/button/AddEntityButton';
import { ProductTypesForm } from '../../forms/ProductTypesForm';

interface ProductTypesTableToolbarProps<TData> {
  table: Table<TData>;
}

export function ProductTypesTableToolbar<TData>({
  table,
}: ProductTypesTableToolbarProps<TData>) {
      ...
      <div className="grid grid-cols-1 md:flex  items-center justify-between gap-2 mt-4 px-1">
        ...
        <div className="flex gap-2">
          ...
          <AddEntityButton
            ...
            buttonLabel="Add Product Types"
            dialogTitle="Add Product Types"
            dialogDescription="Add the product types detail below."
          />
        </div>
      </div>
    </>
